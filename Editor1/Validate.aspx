        ...
        <div class="container-fluid dynamic-content">
            <div class="row">
                <div class="col-md-offset-4 col-md-4 col-md-offset-4 well">
                    <div>
                        <h3 style="text-align:center">Validate Pending Reports</h3><br />
                ...
                <div class="col-md-offset-4 col-md-4 col-md-offset-4 well">
                    <div>                       
                        ...
                        <asp:TextBox ID="message" runat="server" CssClass="form-control"></asp:TextBox><hr />
                         ...
                         <asp:Button ID="request" runat="server" Text="Request Approval" CssClass="btn btn-success btn-md" OnClick="request_Click"/>
                    </div>
                </div>
            </div>
        </div>
