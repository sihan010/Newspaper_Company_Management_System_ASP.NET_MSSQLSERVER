<%@ Page Title="Management" Language="C#" AutoEventWireup="true" CodeFile="Management.aspx.cs" Inherits="Management" MasterPageFile="~/Site.master" %>
    ...
    <div class="row" style="margin-bottom:100px;background-color:lightyellow">
        <div class="col-md-offset-1 col-md-2 sidebar">
          <ul class="nav nav-sidebar">
            <li>
                <asp:LinkButton ID="View" runat="server" OnClick="View_Click" Text="Employee Records"></asp:LinkButton>
            </li>
            <li>
