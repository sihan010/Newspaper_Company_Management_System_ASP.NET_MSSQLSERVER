<%@ Page Title="Senior Editor" Language="C#" AutoEventWireup="true" CodeFile="Senior.aspx.cs" Inherits="Senior" MasterPageFile="~/Site.master" %>
    ...
    <div class="row" style="margin-bottom:100px;background-color:lightyellow">
        <div class="col-md-offset-1 col-md-2 sidebar">
          <ul class="nav nav-sidebar">
            <li>
                <asp:LinkButton ID="Validate" runat="server" OnClick="Validate_Click" Text="Validate Reports"></asp:LinkButton>
            </li>
            <li>
                <asp:LinkButton ID="View" runat="server" OnClick="View_Click" Text="View Reports"></asp:LinkButton>
            </li>
            <li>
                <asp:LinkButton ID="employee" runat="server" OnClick="employee_Click" Text="View Employee Records"></asp:LinkButton>
            </li>
              <li>
